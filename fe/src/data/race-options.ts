...
export const raceData: RaceData[] = [
  {
    ...
    traitSummaries: [
      ...
      {
        name: '노움의 재치',
        summary: '마법에 저항하는 지능, 지혜, 매력 내성 굴림에 유리함을 얻습니다.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    traitSummaries: [
      ...
      {
        name: '이동속도',
        summary: '기본 보행 이동속도는 25피트이며 중갑을 입어도 감소하지 않습니다.',
      },
      {
        name: '드워프의 회복력',
        summary: '독 관련 내성 굴림에 유리함을 얻고 독 피해에 저항합니다.',
      },
      {
        name: '드워프의 강인함',
        summary: '언덕 드워프 기준 최대 HP가 1 증가하고 레벨업 때마다 추가 HP를 얻습니다.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    traitSummaries: [
      {
        name: '능력치 증가',
        summary: '매력이 2 증가하고, 다른 두 능력치를 각각 1씩 선택해 올립니다.',
      },
      { name: '이동속도', summary: '기본 보행 이동속도는 30피트입니다.' },
  ...
  },
  {
    ...
    traitSummaries: [
      {
        name: '능력치 증가',
        summary: '민첩이 2 증가하고, 라이트풋 하플링 기준 매력이 1 증가합니다.',
      },
      { name: '이동속도', summary: '기본 보행 이동속도는 25피트입니다.' },
      { name: '행운', summary: 'd20 결과가 1이면 한 번 더 굴릴 수 있습니다.' },
      {
        name: '타고난 은신성',
        summary: '라이트풋 하플링은 큰 크리처 뒤에 숨어도 숨기를 시도할 수 있습니다.',
      },
    ],
  },
];
