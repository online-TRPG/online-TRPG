...
from app.srd.retrieval import SrdRetriever, load_monsters


def test_generated_monster_catalog_preserves_expected_count_and_core_fields():
...
def test_monster_retrieval_matches_korean_and_english_names():
    retriever = SrdRetriever(monsters=load_monsters(), spells=[], conditions=[], magic_items=[])
