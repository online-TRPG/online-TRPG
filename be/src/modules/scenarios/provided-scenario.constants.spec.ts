import {
  ...
  INTERNAL_VALIDATION_SCENARIO_IDS,
...
describe("provided scenario constants", () => {
  it("uses the seeded system scenario as default and exposes provided scenarios", () => {
    ...
    expect(INTERNAL_VALIDATION_SCENARIO_IDS).toEqual([
    ...
    expect(isProvidedScenarioId("scenario_rule_runtime_smoke")).toBe(false);
    expect(isInternalValidationScenarioId("scenario_rule_runtime_smoke")).toBe(true);
